...
class DataProcessingOptions:
    ...
    def parse_args(self):
        ...
        self.parser.add_argument(
            "--source_video_dir",
            type=str,
            default="./asserts/split_video_25fps",
            help="path of source video in 25 fps",
        )
        self.parser.add_argument(
            "--openface_landmark_dir",
            type=str,
            default="./asserts/split_video_25fps_landmark_openface",
            help="path of openface landmark dir",
        )
        self.parser.add_argument(
            "--video_frame_dir",
            type=str,
            default="./asserts/split_video_25fps_frame",
            help="path of video frames",
        )
        self.parser.add_argument(
            "--audio_dir",
            type=str,
            default="./asserts/split_video_25fps_audio",
            help="path of audios",
        )
        self.parser.add_argument(
            "--deep_speech_dir",
            type=str,
            default="./asserts/split_video_25fps_deepspeech",
            help="path of deep speech",
        )
        self.parser.add_argument(
            "--crop_face_dir",
            type=str,
            default="./asserts/split_video_25fps_crop_face",
            help="path of crop face dir",
        )
        self.parser.add_argument(
            "--json_path",
            type=str,
            default="./asserts/training_json.json",
...
class DINetTrainingOptions:
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--lamb_L1', type=float, default=10.0, help='weight for L1 reconstruct loss')
